...
def extract_compcor(confounds_df, confounds_meta,
    ...
    if 'Method' in confounds_meta[c]
    and confounds_meta[c]['Method'] == method
    and confounds_meta[c].get('Retained', False)}
...
if __name__ == '__main__':
    ...
    afni_pipe = 'filter'
    afni_dir = join(base_dir, afni_pipe)
    #afni_dir = join(base_dir,'mri','bids', 'derivatives', afni_pipe)
